...
To follow the waypoints, **follow_waypoints** package is used. This package basically tracks the Estimate pose that is placed in Rvis and stored. Then these positions should be published in a topic that starts sending them to the movebase system. So, follow_waypoints is gotten from the github and compiled:
